package com.huaji.wms.common.controller;
...
import com.huaji.wms.common.service.Interface.StockRecordManageService;
import com.huaji.wms.common.util.Response;
import com.huaji.wms.common.util.ResponseUtil;
        ...
        switch (searchType) {
            case SEARCH_ALL:
                if (StringUtils.isNumeric(repositoryBelong)) {
                    ...
                    queryResult = storageManageService.selectAll(Integer.valueOf(-1), offset, limit);
                }
                break;
